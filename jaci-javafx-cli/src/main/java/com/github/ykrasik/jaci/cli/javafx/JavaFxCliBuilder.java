...
public class JavaFxCliBuilder {
    ...
    public JavaFxCliBuilder setFxmlPath( String fxmlPath) {
        if (fxmlPath == null) {
            throw new java.lang.NullPointerException("fxmlPath");
        }
    ...
    public JavaFxCliBuilder setFxmlUrl( URL fxmlUrl) {
        if (fxmlUrl == null) {
            throw new java.lang.NullPointerException("fxmlUrl");
        }
    ...
    public Parent build() {
        try {
            ...
            final CliShell shell = new CliShell.Builder(hierarchy, output).setMaxCommandHistory(maxCommandHistory).build();
