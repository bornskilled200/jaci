...
public class CommandHierarchyDef {
    ...
    public static class Builder {
        ...
        public Builder processClasses( Class<?>... classes) {
            if (classes == null) {
                throw new java.lang.NullPointerException("classes");
            }
        ...
        public Builder process( Object... instances) {
            if (instances == null) {
                throw new java.lang.NullPointerException("instances");
            }
        ...
        public java.lang.String toString() {
            return "CommandHierarchyDef.Builder(root=" + this.root + ")";
        }
    }

    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    private CommandHierarchyDef(final CommandDirectoryDef root) {
        this.root = root;
    }
}