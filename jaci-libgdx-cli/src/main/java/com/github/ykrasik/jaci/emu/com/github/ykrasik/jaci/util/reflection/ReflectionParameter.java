...
public class ReflectionParameter {
    ...
    public ReflectionParameter( Class<?> parameterType,  Annotation[] annotations, int index) {
        if (parameterType == null) {
            throw new java.lang.NullPointerException("parameterType");
        }
        if (annotations == null) {
            throw new java.lang.NullPointerException("annotations");
        }
    ...
    public java.lang.String toString() {
        return "ReflectionParameter(parameterType=" + this.getParameterType() + ", annotations=" + java.util.Arrays.deepToString(this.getAnnotations()) + ", index=" + this.getIndex() + ")";
    }
}