...
public class ParsedPath implements Iterable<String> {
    ...
    public static ParsedPath toDirectory( String rawPath) {
        if (rawPath == null) {
            throw new java.lang.NullPointerException("rawPath");
        }
    ...
    public boolean equals(final java.lang.Object o) {
        ...
        final ParsedPath other = (ParsedPath)o;
        if (!other.canEqual((java.lang.Object)this)) return false;
        if (this.startsWithDelimiter != other.startsWithDelimiter) return false;
    ...
    protected boolean canEqual(final java.lang.Object other) {
        return other instanceof ParsedPath;
    }
    ...
    public int hashCode() {
        final int PRIME = 59;
        int result = 1;
        result = result * PRIME + (this.startsWithDelimiter ? 79 : 97);
    ...
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    private ParsedPath(final boolean startsWithDelimiter, final List<String> elements) {
