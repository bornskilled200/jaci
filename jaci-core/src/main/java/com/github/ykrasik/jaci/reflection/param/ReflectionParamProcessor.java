...
public class ReflectionParamProcessor {
    ...
    public ReflectionParamProcessor() {
        this(new StringAnnotationParamFactory(), new BooleanAnnotationParamFactory(), new IntAnnotationParamFactory(), new DoubleAnnotationParamFactory());
    }
    ...
    ReflectionParamProcessor( MethodParamFactory<?>... factories) {
        if (factories == null) {
            throw new java.lang.NullPointerException("factories");
        }
