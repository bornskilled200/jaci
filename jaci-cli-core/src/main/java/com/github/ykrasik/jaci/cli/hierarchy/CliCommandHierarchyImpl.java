...
public class CliCommandHierarchyImpl implements CliCommandHierarchy {
    ...
    private CliCommandHierarchyImpl( CliDirectory root,  CliDirectory systemCommands) {
        if (root == null) {
            throw new java.lang.NullPointerException("root");
        }
        if (systemCommands == null) {
            throw new java.lang.NullPointerException("systemCommands");
        }
        this.root = root;
    ...
    public void setWorkingDirectory( CliDirectory workingDirectory) {
        if (workingDirectory == null) {
            throw new java.lang.NullPointerException("workingDirectory");
        }
    ...
    public static CliCommandHierarchyImpl from( CommandHierarchyDef def) {
        if (def == null) {
            throw new java.lang.NullPointerException("def");
        }
    ...
    private static class CliCommandHierarchyPromise implements CliCommandHierarchy {
        ...
        public void setHierarchy(final CliCommandHierarchy hierarchy) {
            this.hierarchy = hierarchy;
        }

        @java.lang.SuppressWarnings("all")
        @javax.annotation.Generated("lombok")
        public com.github.ykrasik.jaci.cli.directory.CliDirectory getWorkingDirectory() {
            return this.hierarchy.getWorkingDirectory();
        }

        @java.lang.SuppressWarnings("all")
        @javax.annotation.Generated("lombok")
        public void setWorkingDirectory(final com.github.ykrasik.jaci.cli.directory.CliDirectory workingDirectory) {
            this.hierarchy.setWorkingDirectory(workingDirectory);
        }

        @java.lang.SuppressWarnings("all")
        @javax.annotation.Generated("lombok")
        public com.github.ykrasik.jaci.cli.directory.CliDirectory parsePathToDirectory(final java.lang.String rawPath) throws com.github.ykrasik.jaci.cli.exception.ParseException {
            return this.hierarchy.parsePathToDirectory(rawPath);
        }

        @java.lang.SuppressWarnings("all")
        @javax.annotation.Generated("lombok")
        public com.github.ykrasik.jaci.cli.command.CliCommand parsePathToCommand(final java.lang.String rawPath) throws com.github.ykrasik.jaci.cli.exception.ParseException {
            return this.hierarchy.parsePathToCommand(rawPath);
        }

        @java.lang.SuppressWarnings("all")
        @javax.annotation.Generated("lombok")
        public com.github.ykrasik.jaci.cli.assist.AutoComplete autoCompletePathToDirectory(final java.lang.String rawPath) throws com.github.ykrasik.jaci.cli.exception.ParseException {
            return this.hierarchy.autoCompletePathToDirectory(rawPath);
        }

        @java.lang.SuppressWarnings("all")
        @javax.annotation.Generated("lombok")
        public com.github.ykrasik.jaci.cli.assist.AutoComplete autoCompletePath(final java.lang.String rawPath) throws com.github.ykrasik.jaci.cli.exception.ParseException {
            return this.hierarchy.autoCompletePath(rawPath);
        }
    }
}