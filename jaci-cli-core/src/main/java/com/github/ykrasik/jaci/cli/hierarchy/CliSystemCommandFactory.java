...
public class CliSystemCommandFactory {
    ...
    CliCommand createChangeDirectoryCommand() {
        ...
        final List<CliParam> params = Collections.<CliParam>singletonList(new DirectoryCliParam.Builder("dir", hierarchy).setDescription("Directory to change to").build());
    ...
    CliCommand createListDirectoryCommand() {
        ...
        final List<CliParam> params = Arrays.<CliParam>asList(new DirectoryCliParam.Builder("dir", hierarchy).setDescription("Directory to list").setOptional(new Spplr<CliDirectory>(){
        ...
        }).build(), BooleanCliParam.optional(new Identifier("r", "Whether to recurse into sub-directories"), false));
        return CliCommand.from(identifier, params, new CommandExecutor(){
    ...
    CliCommand createDescribeCommandCommand() {
        ...
        final List<CliParam> params = Collections.<CliParam>singletonList(new CommandCliParam.Builder("cmd", hierarchy).setDescription("Command to describe").build());
        return CliCommand.from(identifier, params, new CommandExecutor(){
    ...
    public static CliDirectory from( CliCommandHierarchy hierarchy) {
        ...
        return CliDirectory.from(identifier, factory.createChangeDirectoryCommand(), factory.createListDirectoryCommand(), factory.createDescribeCommandCommand());
    }

    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    private CliSystemCommandFactory(final CliCommandHierarchy hierarchy) {
